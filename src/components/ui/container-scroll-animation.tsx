...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-pink-200 p-2 md:p-6 bg-gradient-to-br from-pink-50 to-amber-50 rounded-[30px] shadow-2xl"
    >
